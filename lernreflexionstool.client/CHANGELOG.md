...
- Create Angular project with ng: `ng new lernreflexionstool.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`lernreflexionstool.client.esproj`).
